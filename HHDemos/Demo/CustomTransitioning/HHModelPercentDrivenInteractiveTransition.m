...
@interface HHModelPercentDrivenInteractiveTransition ()
...
@implementation HHModelPercentDrivenInteractiveTransition
{
    BOOL _isFirst;
}
...
- (void)interPercentFinish:(CGFloat)scale{
    ...
    [UIView animateWithDuration:0.4 delay:0.0 usingSpringWithDamping:0.8 initialSpringVelocity:0.1 options:UIViewAnimationOptionCurveLinear animations:^{
        ...
        [weakSelf.blackBgView removeFromSuperview];
        [weakSelf.beforeImgWhiteView removeFromSuperview];
        weakSelf.blackBgView = nil;
        weakSelf.beforeImgWhiteView = nil;
